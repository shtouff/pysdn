...
def brasse_le_plus_3():
    ...
    s1.cards[0].ports[22].connect(p2.ports[0])
    s1.cards[0].ports[23].connect(p2.ports[1])
    s2.cards[0].ports[22].connect(p2.ports[2])
    s2.cards[0].ports[23].connect(p2.ports[3])
    s3.cards[0].ports[23].connect(p2.ports[4])
    s4.cards[0].ports[23].connect(p2.ports[5])
...
def brasse_le_plus_4():
    ...
    s1.cards[0].ports[22].connect(p3.ports[0])
    s1.cards[0].ports[23].connect(p3.ports[1])
    s2.cards[0].ports[22].connect(p3.ports[2])
    s2.cards[0].ports[23].connect(p3.ports[3])
    s3.cards[0].ports[22].connect(p3.ports[4])
    s3.cards[0].ports[23].connect(p3.ports[5])
    ...
    s1.cards[0].ports[22].connect(p4.ports[0])
    s1.cards[0].ports[23].connect(p4.ports[1])
    s2.cards[0].ports[22].connect(p4.ports[2])
    s2.cards[0].ports[23].connect(p4.ports[3])
