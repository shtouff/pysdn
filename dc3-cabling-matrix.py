...
from pysdn import Port, Transceiver, Connector
from pysdn.devices import PatchPanel, Router, LineCard
...
def brasse_la_baie_telecom():
    ...
    # U7-8: 28 cuivre
    pc = PatchPanel(connector=Connector.RJ45, name='pc', size=28, height=2)
    r.rack(pc, u=7)
